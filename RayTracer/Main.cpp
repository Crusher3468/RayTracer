...
{
	// Light
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 5, 5, 3 }, 1.0f, std::make_unique<Emissive>(color3{ 50, 50, 50 })));

	// Objects
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ -1.25f, 0, -1 }, 0.5f, std::make_unique<Lambertian>(color3{ 1, 1, 0 })));
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 0, 0, -1 }, 0.5f, std::make_unique<Metal>(color3{ 1, 1, 1 }, 0.1f)));
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 1.25f, 0, -1 }, 0.5f, std::make_unique<Dielectric>(color3{ 1, 1, 1 }, 2.0f)));
